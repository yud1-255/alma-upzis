...
This repository was shared with open source license (see `License` section), free for use, remix, and modification for Zakat management purposes where applicable.
